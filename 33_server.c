...
/*
mohit@mohit-VMware-Virtual-Platform:~/Desktop/HandsOn2$ gcc -o 33s 33_server.c
mohit@mohit-VMware-Virtual-Platform:~/Desktop/HandsOn2$ ./33s
server Socket created
Binding to server socket was successful!
Listning from Connection Write massage form server to client: this is server
